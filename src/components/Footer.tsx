import { FaLinkedin, FaYoutube, FaInstagram, FaMapMarkerAlt, FaEnvelope, FaPhone, FaChevronDown } from 'react-icons/fa';
    ...
    <footer className="bg-[linear-gradient(90deg,_#595959_0%,_#3C3C3C_100%)] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="flex flex-col sm:flex-row md:justify-end md:space-x-16 w-full items-start text-left">
            {/* Company Links */}
            <div className="mb-4 sm:mb-0 min-w-[140px] w-full sm:w-auto border-b border-white/10 sm:border-none pb-4 sm:pb-0">
              <details className="group sm:hidden">
                <summary className="flex justify-between items-center cursor-pointer list-none text-lg font-semibold mb-2 sm:mb-4">
                  Company
                ...
                <ul className="space-y-2 mt-2">
                  <li><Link to="/about" className="text-white/80 hover:text-white transition-colors block py-1">About Us</Link></li>
                  <li><a href="#" className="text-white/80 hover:text-white transition-colors block py-1">Services</a></li>
                  <li><Link to="/careers" className="text-white/80 hover:text-white transition-colors block py-1">Career</Link></li>
                  <li><a href="#" className="text-white/80 hover:text-white transition-colors block py-1">Blog</a></li>
                </ul>
              </details>
              {/* Desktop View */}
              <div className="hidden sm:block">
                ...
                <ul className="space-y-2">
                  ...
                  <li><Link to="/careers" className="text-white/80 hover:text-white transition-colors">Career</Link></li>
            ...
            {/* Contact Info */}
            <div className="min-w-[280px] w-full sm:w-auto border-b border-white/10 sm:border-none pb-4 sm:pb-0">
              <details className="group sm:hidden">
                <summary className="flex justify-between items-center cursor-pointer list-none text-lg font-semibold mb-2 sm:mb-4">
                  Contact
                  <span className="transition group-open:rotate-180">
                ...
                <ul className="space-y-4 mt-2">
                  <li className="flex flex-col sm:flex-row items-center sm:items-start gap-2 sm:gap-3">
                    <div className="flex items-start gap-3">
                      <FaMapMarkerAlt className="text-xl mt-1 shrink-0" />
        ...
        <div className="border-t border-white/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-center gap-2">
          ...
          <div className="flex space-x-4">
            <Link to="/privacy-policy" className="text-white/80 hover:text-white text-sm">Privacy Policy</Link>
